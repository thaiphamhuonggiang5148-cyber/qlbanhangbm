...
<img src={product.image || 'https://via.placeholder.com/300x200'}alt={product.name}className="product-image"/></div>
...
<button className="ram-ssd-tag">{product.sizeL}</button></div>
